...
class HandCodedLaneFollower(object):
    ...
    def steer(self, frame, lane_lines):
        ...
        curr_heading_image = display_heading_line(
            frame, self.curr_steering_angle, len(lane_lines))
...
def display_heading_line(frame, steering_angle, numberOflines, line_color=(0, 0, 255), line_width=5, ):
    ...
    if(((steering_angle == 89) and (numberOflines == 1)) or (0 <= steering_angle < 80)):
        print(' right')
        DirectionSendToServer.append('6')
        print('r')
# or (streeung_angle == 95) and numberOfLines ==2
    elif ((80 <= steering_angle <= 100) and (numberOflines == 2)):
        ...
        print('s')
        DirectionSendToServer.append('2')
...
def test_photo(file):
    ...
    print("Tested ",DirectionSendToServer[-1])
    return(DirectionSendToServer[-1],final_angle)